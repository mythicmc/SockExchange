 ...
 */
public class SlfBasicLogger implements BasicLogger
{
    private final Logger logger;
    private volatile boolean debugMode;

    public SlfBasicLogger(Logger logger, boolean debugMode)
    {
    ...
    {
        logger.info(formatWithParams(format, false, params));
    }
    ...
    public void debug(String format, Object... params)
    {
        if (debugMode)
        {
            logger.info(formatWithParams(format, true, params));
        }
    }
    ...
    {
        logger.error(formatWithParams(format, false, params));
    }
    ...
    private static String formatWithParams(String format, boolean prefixWithDebug, Object... params)
    {
        ...
        while (paramIdx < params.length && strIdx < formatLen)
        {
            ...
            if (indexOfNextParam >= 0)
            {
                ...
                builder.append(format, strIdx, indexOfNextParam);
            ...
            else
            {
                ...
                builder.append(format, strIdx, formatLen);
                strIdx = formatLen;
            }
        }
